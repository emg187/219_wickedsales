...
if (empty($_SESSION["cart_id"])){
    ...
    $cart_select_query = "SELECT `item_count`, `total_price` FROM `carts` WHERE `id`=$cart_id";
    $cart_select_result = mysqli_query($conn, $cart_select_query);

    if (!$cart_select_result){
    ...
    $row = mysqli_fetch_assoc($cart_select_result);
